    ...
    return (
        <BoddyInfo>
            ...
            <div className='btn__follow'>
                ...
                <a href='https://www.linkedin.com/in/jesusarechider/' target="_blank" rel="noopener noreferrer"><button>Go Linkedin </button></a>
            </div>
            <h2>Jesus Arechider <i className="fa-solid fa-screwdriver-wrench fa-spin-pulse"></i></h2>
            <h3>Technology science lover! ✨</h3>
            <p className='des__job'>Web Development. Creative Content Creator.
                Electrical Engineering. IT Support. Machine Learning in progress.
            </p>
            <ul className='details__info'>
                <li> <i className="fa-solid fa-briefcase fa-bounce" style={{ color: 'green' }}></i> Available</li>
                <Link to='/works'><li> <i className="fa-solid fa-link" style={{ color: '#e619c3' }}></i>/works</li></Link>
                <li> <i className="fa-solid fa-cake-candles"></i> December 1st, 1993</li>
